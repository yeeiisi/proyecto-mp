...
public:
    ...
    /*
     * @brief Devuelve un string que contiene la información de la variable competición
     * @return un string con el contenido de la variable competición 
     */
    string esquemaCompeticion();
    
    /*
     * @brief Este método actualiza la información del campeonato con los resultados de una partida 
     * recién realizada. jug1 representa el id del jugador ganador y jug2 al perdedor.
     * en la matriz competición, la posición referente a la cantidad de partidas ganadas del
     * jugador 1 contra el jugador 2 debe incrementarse en 1.
     */
