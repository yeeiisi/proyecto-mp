...
public: 
    ...
    /**
     * @brief Reserva la memoria para la matriz m.
     * @param f tamaño de las filas
     * @param c tamaño de las columnas 
    */
    ...
    */
     ...
     * @return devuleve una referencia al objeto
     */
    MatrizEnteros & operator=(const MatrizEnteros &orig);
    
    
    /**
     * @brief imprimir la matriz por pantalla
     * @return devuelve la variable flujo 
     */
    friend std::ostream & operator<< (std::ostream & flujo, const MatrizEnteros & m);
