...
${OBJECTDIR}/src/ConjuntoJugadores.o: src/ConjuntoJugadores.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ConjuntoJugadores.o src/ConjuntoJugadores.cpp

${OBJECTDIR}/src/Jugador.o: src/Jugador.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Jugador.o src/Jugador.cpp

${OBJECTDIR}/src/MatrizEnteros.o: src/MatrizEnteros.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MatrizEnteros.o src/MatrizEnteros.cpp

${OBJECTDIR}/src/Partida.o: src/Partida.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Partida.o src/Partida.cpp

${OBJECTDIR}/src/Tablero.o: src/Tablero.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Tablero.o src/Tablero.cpp
